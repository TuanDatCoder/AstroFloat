...
export default function UnauthorizedPage() {
  return (
    <div className="fixed inset-0 z-[9999] bg-[#020617] flex flex-col items-center justify-center p-6 overflow-hidden">
      ...
      {/* Background glow */}
      <div className="absolute top-1/4 left-1/2 -translate-x-1/2 w-full h-[600px] bg-[radial-gradient(circle_at_center,_rgba(225,29,72,0.06)_0%,_transparent_70%)] pointer-events-none" />
