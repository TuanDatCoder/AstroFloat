...
import { ArrowLeft, Save, Loader2, BookOpen, Heart } from 'lucide-react';
import { nameNumerologyService } from '@/services/nameNumerologyService';
import { FIELD_NAME_NUMEROLOGY } from '@/constants';

export default function AdminNameNumerologyFormClient({ number }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      router.push('/admin/name-numerology');
    } catch (error) {
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6 pb-20">
      <div className="flex items-center gap-4">
        <Link href="/admin/name-numerology" className="p-2 hover:bg-white/5 rounded-lg text-gray-400">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
           ...
           <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-2">
                ...
                <textarea 
                  ...
                  rows={4}
                  className="w-full bg-black/40 border border-white/10 rounded-[2rem] px-6 py-5 text-white focus:border-indigo-500/50 focus:outline-none"
              ...
              <div className="space-y-2">
                ...
                <textarea 
                  ...
                  rows={4}
                  className="w-full bg-black/40 border border-white/10 rounded-[2rem] px-6 py-5 text-white focus:border-pink-500/50 focus:outline-none"
        ...
        <div className="flex justify-end gap-3 px-2">
          <button 
            type="button" onClick={() => router.push('/admin/name-numerology')}
