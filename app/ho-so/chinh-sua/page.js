    ...
    <div className="flex flex-col items-center justify-center min-h-screen py-24 px-4 relative z-10 w-full overflow-hidden">
      ...
      >
        ...
        <div className="flex items-center justify-between mb-10 relative z-10">
          <Link href={ROUTES.PROFILE} className="w-12 h-12 flex items-center justify-center rounded-2xl bg-white/5 border border-white/10 text-gray-400 hover:text-white hover:bg-white/10 transition-all">
        ...
        <form onSubmit={handleSubmit} className="relative z-10">
          ...
          <div className="flex flex-col items-center mb-8">
            <div className="relative group cursor-pointer w-28 h-28 rounded-full border-2 border-dashed border-white/30 overflow-hidden bg-white/5 flex items-center justify-center hover:border-cyan-400 transition-colors">
              ...
              <div className="absolute inset-0 bg-black/50 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center text-[10px] font-bold tracking-widest uppercase text-white">
                Tải ảnh lên
              </div>
              <input 
                type="file" 
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-10">
            ...
            <div className="space-y-6">
              ...
              <p className="text-xs text-gray-500">
                <span className="text-amber-400">Lưu ý:</span> Việc thay đổi thông tin khai sinh sẽ làm cập nhật lại báo cáo của bạn.
              </p>
