  ...
  return (
    <div className="flex flex-col items-center pt-28 pb-24 px-4 md:px-6 relative z-10 w-full max-w-3xl mx-auto min-h-screen">
      ...
      {loading ? (
        ...
        <div className="text-center bg-slate-900/40 p-10 rounded-[2rem] border border-white/5 w-full">
          ...
          {ranking.map(({ sign, catScores, overall }, idx) => {
            ...
            return (
              <motion.div
                ...
                className={`relative w-full rounded-3xl border bg-slate-900/60 backdrop-blur-xl p-6 ${style.ring} ${style.glow} transition-all hover:bg-slate-800/70`}
              >
