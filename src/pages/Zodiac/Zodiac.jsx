  ...
  return (
    <div className="flex flex-col items-center pt-10 pb-20 px-6 relative z-10 w-full max-w-7xl mx-auto min-h-[80vh]">
      ...
      <motion.div
        ...
        className="mb-12 w-full max-w-lg mx-auto bg-slate-900/60 backdrop-blur-md p-6 md:p-8 rounded-[2rem] border border-cyan-500/20 shadow-2xl flex flex-col sm:flex-row gap-4 items-center relative z-20"
      >
            ...
            {data.map((sign, index) => (
              <Link to={`/zodiac/${sign.id}`} key={sign.id || index} className="block">
                ...
                >
                  ...
                  <div className="relative h-full px-8 py-10 bg-slate-900/80 backdrop-blur-sm rounded-[31px] flex flex-col justify-between border border-white/5 transition-colors duration-500 group-hover:bg-slate-900/60">
                    <motion.div
                      animate={{ y: [-4, 4, -4] }}
