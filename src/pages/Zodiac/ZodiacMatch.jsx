...
const CustomSelect = ({ value, onChange, options, placeholder, isPink }) => {
 ...
 exit={{ opacity: 0, y: -10 }}
 className={`absolute z-50 w-full mt-2 bg-slate-900/95 border ${isPink ? 'border-pink-500/20' : 'border-purple-500/20'} rounded-2xl shadow-2xl overflow-hidden max-h-64 overflow-y-auto`}
...
export default function ZodiacMatch() {
 ...
 className={`px-6 py-2.5 rounded-full font-bold text-sm tracking-widest transition-all uppercase ${matchMode === 'date' ? 'bg-gradient-to-r from-pink-500 to-purple-500 text-white shadow-[0_0_20px_rgba(236,72,153,0.4)]' : 'bg-black/60 text-gray-500 border border-white/5 hover:text-white hover:border-white/20'}`}
 >
 Theo Ngày Sinh
 </button>
 <button 
 onClick={() => { setMatchMode('sign'); setResult(null); }}
 className={`px-6 py-2.5 rounded-full font-bold text-sm tracking-widest transition-all uppercase ${matchMode === 'sign' ? 'bg-gradient-to-r from-indigo-500 to-cyan-500 text-white shadow-[0_0_20px_rgba(99,102,241,0.4)]' : 'bg-black/60 text-gray-500 border border-white/5 hover:text-white hover:border-white/20'}`}
 >
 Chọn Cung
 </button>
 </div>
 ...
 initial="hidden"
 animate="visible"
 className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 w-full max-w-4xl mb-12 relative z-20"
 >
 <motion.div variants={itemVariants} className="bg-slate-900/80 p-6 rounded-3xl border border-white/10 shadow-xl relative z-30">
 ...
 <motion.div variants={itemVariants} className="bg-slate-900/80 p-6 rounded-3xl border border-white/10 shadow-xl relative z-20">
 ...
 className="px-12 py-4 bg-gradient-to-r from-pink-600 via-purple-600 to-indigo-600 hover:from-pink-500 hover:via-purple-500 hover:to-indigo-500 rounded-2xl font-bold text-white shadow-[0_10px_30px_rgba(236,72,153,0.3)] disabled:opacity-50 transition-all flex items-center gap-3 text-lg mb-16 relative z-10"
 >
 {loading ? (
 ...
 className="bg-black/60 p-8 rounded-[2rem] border border-white/5 space-y-4"
 >
