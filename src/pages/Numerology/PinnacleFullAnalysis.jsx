...
export default function PinnacleFullAnalysis() {
 ...
 <div className="bg-slate-900/80 p-8 rounded-[3rem] border border-white/5 hover:border-indigo-500/30 transition-all duration-500 group shadow-2xl relative overflow-hidden">
 ...
 <div className="group-hover:line-clamp-none line-clamp-4 transition-all duration-500">
 {formatContent(detail?.content || "Dữ liệu đang được kết nối với tần số vũ trụ...")}
 </div>
