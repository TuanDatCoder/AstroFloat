...
import { User, Sparkles, Star, ChevronRight, Briefcase, Heart, Lightbulb, AlertCircle, Info, Target, Quote } from 'lucide-react';
...
export default function NameNumerology() {
  ...
  useEffect(() => {
    ...
    if (nameParam) {
      // Vì handleCalculate phụ thuộc vào state 'name' vừa set ở trên
      // nên ta có thể gọi trực tiếp hoặc dùng nameParam
  ...
  const handleCalculate = async () => {
    ...
    try {
      ...
      // Lấy thêm các chỉ số nâng cao từ bảng name_advanced_metrics
      const advancedMetrics = await nameNumerologyService.getAdvancedMetrics(
        analysis.soulNumber,
        analysis.personalityNumber,
        analysis.balanceNumber,
  ...
  return (
    <div className="flex flex-col items-center pt-20 pb-24 px-6 relative z-10 w-full max-w-7xl mx-auto min-h-[80vh]">
      ...
      <motion.div
        ...
        className="w-full max-w-2xl bg-slate-900/60 backdrop-blur-2xl p-6 md:p-8 rounded-[2.5rem] border border-white/10 shadow-2xl mb-16 relative overflow-hidden"
      >
        ...
        <div className="flex flex-col gap-6">
          <div className="relative group">
            ...
            <input 
              ...
              className="w-full bg-black/40 border border-white/5 rounded-2xl pl-14 pr-4 py-5 text-white text-xl placeholder:text-gray-600 focus:outline-none focus:border-purple-500/30 focus:bg-black/60 transition-all font-medium"
          ...
          <button
            ...
            className="w-full py-5 bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-500 hover:to-indigo-500 rounded-2xl font-black text-lg text-white shadow-[0_8px_30px_rgba(124,58,237,0.3)] disabled:opacity-50 transition-all flex items-center justify-center gap-3 active:scale-95"
          >
            {loading ? (
        ...
        {result && (
          ...
          >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-stretch">
              ...
              <div className="flex flex-col gap-6">
                <motion.div variants={itemVariants} className="flex-1 bg-pink-500/5 backdrop-blur-xl p-8 rounded-[2.5rem] border border-pink-500/20 relative overflow-hidden group">
                ...
                <motion.div variants={itemVariants} className="flex-1 bg-cyan-500/5 backdrop-blur-xl p-8 rounded-[2.5rem] border border-cyan-500/20 relative overflow-hidden group">
              ...
              <motion.div variants={itemVariants} className="bg-slate-900/60 backdrop-blur-3xl rounded-[3rem] border border-white/10 p-10 shadow-2xl relative overflow-hidden text-center flex flex-col items-center justify-center group min-h-[450px]">
              ...
              {/* Karmic & Balance */}
              <div className="flex flex-col gap-6">
                <motion.div variants={itemVariants} className="flex-1 bg-amber-500/5 backdrop-blur-xl p-8 rounded-[2.5rem] border border-amber-500/20 relative overflow-hidden group">
                ...
                <motion.div variants={itemVariants} className="flex-1 bg-emerald-500/5 backdrop-blur-xl p-8 rounded-[2.5rem] border border-emerald-500/20 relative overflow-hidden group">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 pt-4">
               <motion.div variants={itemVariants} className="bg-slate-900/40 p-8 rounded-[2rem] border border-white/5 group hover:border-emerald-500/20 transition-colors">
               ...
               <motion.div variants={itemVariants} className="bg-slate-900/40 p-8 rounded-[2rem] border border-white/5 group hover:border-rose-500/20 transition-colors">
               ...
               <motion.div variants={itemVariants} className="bg-slate-900/40 p-8 rounded-[2rem] border border-white/5 group hover:border-cyan-500/20 transition-colors">
               ...
               <motion.div variants={itemVariants} className="bg-slate-900/40 p-8 rounded-[2rem] border border-white/5 group hover:border-pink-500/20 transition-colors">
               ...
               <motion.div variants={itemVariants} className="bg-amber-500/5 backdrop-blur-xl p-8 rounded-[2rem] border border-amber-500/20 lg:col-span-2">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  {details.map((detail, index) => (
                    <motion.div 
                      ...
                      viewport={{ once: true }}
                      className="bg-slate-900/40 border border-white/5 rounded-3xl p-8 hover:bg-slate-900 transition-colors"
                    >
