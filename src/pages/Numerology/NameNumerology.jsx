...
export default function NameNumerology() {
 ...
 className="w-full max-w-2xl bg-slate-900/80 p-6 rounded-[2.5rem] border border-white/10 shadow-2xl mb-24 relative overflow-hidden"
 >
 ...
 {[...Array(9)].map((_, i) => (
 <div key={i} className="h-64 bg-slate-900/70 rounded-[2.5rem] animate-pulse border border-white/5" />
 ))}
 </div>
 ) : (
 <motion.div
 ...
 className="hover:-translate-y-2 bg-slate-900/80 p-8 rounded-[2.5rem] border border-white/10 flex flex-col items-center text-center group hover:bg-slate-800/80 hover:border-purple-500/30 shadow-2xl relative overflow-hidden transition-transform duration-300 ease-out"
 >
