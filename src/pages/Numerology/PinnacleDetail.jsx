...
export default function PinnacleDetail() {
  ...
  return (
    <div className="flex flex-col items-center pt-24 pb-32 px-6 relative z-10 w-full max-w-5xl mx-auto min-h-screen">
      ...
      {error ? (
        <div className="text-center py-20 bg-slate-900/60 rounded-[3rem] border border-white/10 w-full">
        ...
        >
          {/* Header Card */}
          <div className="bg-slate-900/40 backdrop-blur-3xl p-10 md:p-16 rounded-[4rem] border border-white/10 shadow-2xl relative overflow-hidden group">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="md:col-span-2 space-y-8">
                <div className="bg-slate-900/60 backdrop-blur-3xl p-10 rounded-[3rem] border border-white/10 shadow-xl relative group h-full">
                    <div className="flex items-center gap-3 text-indigo-400 mb-6">
                        <Zap className="w-6 h-6" />
                        <h3 className="font-black text-xs uppercase tracking-widest">Ý nghĩa & Sự kiện chính</h3>
                    </div>
                    <p className="text-gray-300 text-lg font-light leading-loose whitespace-pre-line antialiased">
                        {pinnacle.content}
                    </p>
                </div>
            </div>
            ...
            <div className="space-y-8 h-full">
                <div className="bg-gradient-to-br from-indigo-900/40 to-slate-900/60 backdrop-blur-3xl p-10 rounded-[3rem] border border-indigo-500/20 shadow-xl h-full flex flex-col justify-center">
