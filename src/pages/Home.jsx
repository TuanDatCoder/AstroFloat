    ...
    <div className="flex flex-col items-center justify-center pt-32 pb-40 px-6 min-h-screen relative overflow-hidden w-full">
      ...
      >
        ...
        <motion.div variants={itemVariants}>
          <div className="inline-flex items-center gap-2 py-2 px-6 rounded-full bg-white/5 border border-white/10 text-white/80 text-[10px] font-black tracking-[0.4em] mb-8 shadow-2xl backdrop-blur-xl uppercase">
        ...
        <motion.div variants={itemVariants} className="w-full grid grid-cols-1 md:grid-cols-3 gap-8 px-4">
          ...
          <Link to="/zodiac" className="group">
            <div className="relative h-full p-10 bg-slate-900/40 backdrop-blur-3xl rounded-[3rem] border border-white/5 hover:border-cyan-500/30 transition-all duration-500 flex flex-col items-center text-center">
          ...
          <Link to="/numerology" className="group">
            <div className="relative h-full p-10 bg-slate-900/40 backdrop-blur-3xl rounded-[3rem] border border-white/5 hover:border-purple-500/30 transition-all duration-500 flex flex-col items-center text-center">
          ...
          <Link to="/name-numerology" className="group">
            <div className="relative h-full p-10 bg-slate-900/40 backdrop-blur-3xl rounded-[3rem] border border-white/5 hover:border-emerald-500/30 transition-all duration-500 flex flex-col items-center text-center">
