...
export default function Discover() {
 ...
 className="w-full max-w-xl mx-auto bg-slate-900/80 p-8 rounded-[2rem] border border-emerald-500/30 shadow-[0_0_40px_rgba(16,185,129,0.15)] flex flex-col gap-6 relative z-20 mb-12"
 >
 ...
 <div className="bg-purple-950/80 border border-purple-500/30 rounded-[2rem] p-8 text-left flex flex-col justify-between group hover:bg-purple-900/50 transition-colors shadow-2xl relative overflow-hidden">
 ...
 <div className="bg-cyan-950/80 border border-cyan-500/30 rounded-[2rem] p-8 text-left flex flex-col justify-between group hover:bg-cyan-900/50 transition-colors shadow-2xl relative overflow-hidden">
 <div className="absolute top-0 right-0 p-8 opacity-5 pointer-events-none select-none">
 ...
 <div className="bg-emerald-950/80 border border-emerald-500/30 rounded-[2rem] p-8 text-left flex flex-col items-center justify-center group hover:bg-emerald-900/50 transition-colors shadow-2xl relative overflow-hidden h-full">
 ...
 <div className="bg-indigo-950/80 border border-indigo-500/30 rounded-[2rem] p-8 text-left flex flex-col items-center justify-between group hover:bg-indigo-900/50 transition-colors shadow-2xl relative overflow-hidden h-full">
 ...
 <div className="bg-slate-900/80 border border-white/10 rounded-[2rem] p-8 group hover:bg-slate-800/80 transition-all shadow-2xl relative overflow-hidden flex flex-col justify-between min-h-[300px]">
 <div className="relative z-10">
 <p className="text-purple-400 text-[10px] uppercase font-black tracking-widest mb-4 flex items-center gap-2">
 ...
 <div className="bg-pink-950/80 border border-pink-500/30 rounded-[2rem] p-8 group hover:bg-pink-900/50 transition-all shadow-2xl relative overflow-hidden flex flex-col justify-between min-h-[300px]">
 <div className="absolute top-0 right-0 p-8 opacity-5 pointer-events-none select-none">
 ...
 <div key={idx} className="bg-black/60 w-full p-4 rounded-2xl border border-white/5 flex items-center justify-between hover:border-pink-500/20 cursor-default transition-colors">
