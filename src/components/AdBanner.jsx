...
const AdBanner = ({ className = "", slot = "horizontal" }) => {
  ...
  return (
    <div className={`flex flex-col items-center justify-center my-12 px-4 ${className}`}>
      <div 
        className={`${styles[slot] || styles.horizontal} relative rounded-2xl border border-white/5 bg-slate-900/30 backdrop-blur-xl flex flex-col items-center justify-center overflow-hidden group`}
      >
