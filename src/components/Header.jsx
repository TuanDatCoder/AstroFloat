...
export default function Header() {
 ...
 className="fixed top-16 right-0 h-[calc(100dvh-4rem)] w-4/5 max-w-sm bg-[#0B0F19]/90 border-l border-white/5 lg:hidden z-[-1] p-6 sm:p-8 flex flex-col gap-6 overflow-y-auto"
 >
